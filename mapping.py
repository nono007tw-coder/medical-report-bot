...
LAB_MAPPING = {
    ...
    "RDW-CV": _item(["RDW-CV", "RDW CV", "RDW"], "紅血球分布寬度", "Red Cell Distribution Width, RDW-CV", "抽血檢查", "血液常規檢查", 109),
    "MPV": _item(["MPV"], "平均血小板容積", "Mean Platelet Volume, MPV", "抽血檢查", "血液常規檢查", 110),
    "ANC": _item(["ANC"], "嗜中性球絕對值", "Absolute Neutrophil Count, ANC", "抽血檢查", "血液常規檢查", 111),
    "Band": _item(["Band", "Band."], "帶狀嗜中性球", "Band Neutrophil, Band", "抽血檢查", "血液常規檢查", 112),
    "Neutrophil": _item(["Neu", "Neu.", "Neutrophil", "Neutrophils"], "嗜中性球", "Neutrophil, Neu.", "抽血檢查", "血液常規檢查", 113),
    "Lymphocyte": _item(["Lym", "Lym.", "Lymphocyte", "Lymphocytes"], "淋巴球", "Lymphocyte, Lym.", "抽血檢查", "血液常規檢查", 114),
    "Monocyte": _item(["Mono", "Mono.", "Monocyte", "Monocytes"], "單核球", "Monocyte, Mono.", "抽血檢查", "血液常規檢查", 115),
    "Eosinophil": _item(["Eos", "Eos.", "Eosinophil", "Eosinophils"], "嗜酸性球", "Eosinophil, Eos.", "抽血檢查", "血液常規檢查", 116),
    "Basophil": _item(["Baso", "Baso.", "Basophil", "Basophils"], "嗜鹼性球", "Basophil, Baso.", "抽血檢查", "血液常規檢查", 117),
    # Liver
    ...
    "ALP": _item(["ALP", "ALK-P", "Alk-P", "Alkaline Phosphatase"], "鹼性磷酸酶", "Alkaline Phosphatase, ALP", "抽血檢查", "肝膽功能檢查", 203),
    "GGT": _item(["GGT", "r-GT", "Gamma-GT"], "γ-麩胺醯轉移酶", "Gamma-Glutamyl Transferase, GGT", "抽血檢查", "肝膽功能檢查", 204),
    "Total Bilirubin": _item(["T-Bil", "T.BIL", "T.BILI", "TBIL", "Bil-T", "Total Bilirubin"], "總膽紅素", "Total Bilirubin, T-Bil", "抽血檢查", "肝膽功能檢查", 205),
    "Direct Bilirubin": _item(["D-Bil", "D.BIL", "D.BILI", "DBIL", "Bil-D", "Direct Bilirubin"], "直接膽紅素", "Direct Bilirubin, D-Bil", "抽血檢查", "肝膽功能檢查", 206),
    "Indirect Bilirubin": _item(["I-Bil", "I.BIL", "IBIL", "Indirect Bilirubin"], "間接膽紅素", "Indirect Bilirubin, I-Bil", "抽血檢查", "肝膽功能檢查", 207),
    "Albumin": _item(["ALB", "Albumin"], "白蛋白", "Albumin, Alb", "抽血檢查", "肝膽功能檢查", 208),
    "Total Protein": _item(["TP", "T.PRO", "Total Protein"], "總蛋白", "Total Protein, TP", "抽血檢查", "肝膽功能檢查", 209),
    "LDH": _item(["LDH", "Lactate Dehydrogenase"], "乳酸脫氫酶", "Lactate Dehydrogenase, LDH", "抽血檢查", "肝膽功能檢查", 210),
    # Kidney
    ...
    "eGFR": _item(["eGFR", "eGFR(M)", "eGFR(F)", "eGFR-M", "eGFR-F", "Estimated GFR", "GFR"], "估算腎絲球過濾率", "Estimated Glomerular Filtration Rate, eGFR", "抽血檢查", "腎功能檢查", 303),
    ...
    "Ionized Calcium": _item(["Ca++, free", "Free Calcium", "Ionized Calcium", "iCa"], "游離鈣", "Ionized Calcium, iCa", "抽血檢查", "電解質與酸鹼檢查", 505),
    ...
    "Anion Gap": _item(["AG", "Anion Gap"], "陰離子間隙", "Anion Gap, AG", "抽血檢查", "電解質與酸鹼檢查", 508),
    # Glucose/lipid
    "Glucose": _item(["Glucose", "GLU", "AC Sugar", "Fasting Glucose"], "葡萄糖", "Glucose, Glu", "抽血檢查", "血糖與糖尿病相關檢查", 601),
    "HbA1c": _item(["HbA1c", "A1C", "A1C (HbA1C)", "Glycated Hemoglobin"], "糖化血色素", "Glycated Hemoglobin, HbA1c", "抽血檢查", "血糖與糖尿病相關檢查", 602),
    "Fructosamine": _item(["Fructosamine"], "果糖胺", "Fructosamine", "抽血檢查", "血糖與糖尿病相關檢查", 603),
    "Total Cholesterol": _item(["T-CHOL", "CHOL", "CHOL.", "Total Cholesterol"], "總膽固醇", "Total Cholesterol, TC", "抽血檢查", "血脂檢查", 701),
    ...
    "LDL-C": _item(["LDL", "LDL-C", "LDL-C(實測值)", "LDL Cholesterol"], "低密度脂蛋白膽固醇", "Low-Density Lipoprotein Cholesterol, LDL-C", "抽血檢查", "血脂檢查", 704),
    "Cholesterol/HDL Ratio": _item(["CHOL/HDLC", "CHOL/HDL-C", "TC/HDL"], "總膽固醇／高密度脂蛋白比值", "Total Cholesterol/HDL Ratio", "抽血檢查", "血脂檢查", 705),
    ...
    "Transferrin": _item(["Transferrin"], "轉鐵蛋白", "Transferrin", "抽血檢查", "鐵質與貧血相關檢查", 805),
    "Vitamin B12": _item(["Vitamin B12", "B12"], "維生素 B12", "Vitamin B12", "抽血檢查", "維生素與營養檢查", 902),
    "Folate": _item(["Folate", "Folic Acid"], "葉酸", "Folate", "抽血檢查", "維生素與營養檢查", 903),
    "Vitamin D": _item(["Vitamin D", "25-OH Vitamin D", "25-OH Vitamin D(SP)", "25(OH)D"], "維生素 D", "25-Hydroxyvitamin D, 25(OH)D", "抽血檢查", "維生素與營養檢查", 901),
    ...
    "Free T3": _item(["FREE T3", "Free T3", "FT3"], "游離三碘甲狀腺素", "Free Triiodothyronine, Free T3", "抽血檢查", "甲狀腺功能檢查", 1004),
    ...
    "IL-6": _item(["IL-6", "Interleukin-6"], "介白素 6", "Interleukin-6, IL-6", "抽血檢查", "發炎與感染指標", 1204),
    "Troponin": _item(["Troponin", "Troponin-I", "TROP-I", "hs-TnI"], "心肌肌鈣蛋白", "Cardiac Troponin, cTn", "抽血檢查", "心臟相關檢查", 1401),
    "High-Sensitivity Troponin T": _item(["Hs cTnT", "hs-cTnT", "High-Sensitivity Troponin T"], "高敏感度心肌肌鈣蛋白 T", "High-Sensitivity Cardiac Troponin T, hs-cTnT", "抽血檢查", "心臟相關檢查", 1402),
    ...
    "Fibrinogen": _item(["Fibrinogen", "FIB"], "纖維蛋白原", "Fibrinogen", "抽血檢查", "凝血功能檢查", 1605),
    # Immune
    ...
    "CA-125": _item(["CA-125", "CA125"], "癌抗原 125", "Cancer Antigen 125, CA-125", "抽血檢查", "腫瘤指標", 2005),
    "CA15-3": _item(["CA15-3", "CA 15-3"], "癌抗原 15-3", "Cancer Antigen 15-3, CA15-3", "抽血檢查", "腫瘤指標", 2006),
    "Thyroglobulin": _item(["Thyroglobulin"], "甲狀腺球蛋白", "Thyroglobulin, Tg", "抽血檢查", "甲狀腺功能檢查", 1003),
    ...
    "Urine Protein Dipstick": _item(["Protein", "PRO", "PRO(U)", "Protein Dipstick"], "尿蛋白定性", "Urine Protein, Dipstick", "驗尿檢查", "尿液一般檢查", 2204),
    "Urine Ketone": _item(["Ketone", "Ketone(U)", "KET"], "尿酮體", "Urine Ketone", "驗尿檢查", "尿液一般檢查", 2205),
    "Urine Occult Blood": _item(["OB", "Occult Blood", "Blood(U)"], "尿潛血", "Urine Occult Blood", "驗尿檢查", "尿液一般檢查", 2206),
    "Urine Nitrite": _item(["Nitrite", "NIT"], "尿亞硝酸鹽", "Urine Nitrite", "驗尿檢查", "尿液一般檢查", 2207),
    "Urine Leukocyte Esterase": _item(["Leukocyte Esterase", "LEU"], "尿白血球酯酶", "Urine Leukocyte Esterase", "驗尿檢查", "尿液一般檢查", 2208),
